...
def encode_features(df):
    ...
    # Ensure artifacts directory exists and save classes there
    os.makedirs('artifacts', exist_ok=True)
    np.save('artifacts/classes.npy', encoder.classes_)
...
def train_model(X, y):
    ...
    try:
        ...
        # If experiment already exists, get it
        experiment = mlflow.get_experiment_by_name(experiment_name)
    ...
    with mlflow.start_run(experiment_id=experiment_id):
        ...
        # Persist model artifact to artifacts directory
        os.makedirs('artifacts', exist_ok=True)
